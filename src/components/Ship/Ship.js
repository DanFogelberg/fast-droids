...
class Ship extends React.Component {
  ...
  update() {
    if (keys.w) {
      this.xSpeed =
        this.xSpeed + this.acceleration * Math.sin(this.state.rotation);
      this.ySpeed =
        this.ySpeed - this.acceleration * Math.cos(this.state.rotation);
    }
    if (keys.a) {
  ...
  render() {
    return <this.shipDiv style={this.positionStyle}>^</this.shipDiv>;
  }
}
